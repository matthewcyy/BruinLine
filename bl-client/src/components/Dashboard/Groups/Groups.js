    ...
    return (
        <div style={{textAlign: 'center'}}>
            ...
            <div style={{width: '50%', margin: '2rem auto'}}>
                ...
                <CardContent>
                    <Box sx={{fontWeight: 'bold', fontSize: '1.5rem', marginBottom: "0.75rem"}}>Make a Group</Box>
                    <Grid item xs={12} marginTop="0.5rem">
                        <TextField label="New Group Name" variant="outlined" size="Normal" value={newGroupName} onChange={(e) => setNewGroupName(e.target.value)} fullWidth/>
                    </Grid>
                    <Grid item xs={12} marginTop="0.5rem">
